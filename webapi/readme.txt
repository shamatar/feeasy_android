...
Использует MySQL. Создаётся база feeasy и пользователь feeasyapp с паролем feeasy12930846б имеющий право писать в эту базу данных, но только с localhost.
...
sender_card - понятно
recipient_card_format - должно быть 'pen', в дальнейшем для токинизации будет использоваться
